# genpark-searchable-context-telemetry-retriever-skill
...
**genpark-searchable-context-telemetry-retriever-skill** is a deterministic, zero-dependency Python skill engineered for long-horizon AI coding agent context persistence, anti-looping failure memory, and architectural invariant enforcement.

> **Executive Capability**: Searchable historical context & raw telemetry retriever (Codex Astra)
...
result = client.query_prior_window_telemetry()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-searchable-context-telemetry-retriever-skill": {
      "command": "python",
      "args": ["/path/to/genpark-searchable-context-telemetry-retriever-skill/mcp_server.py"]
    }
  }
}
```
